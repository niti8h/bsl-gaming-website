...
if ($startIndex !== false) {
    // We want to replace from here until we see <div class="elementor-element elementor-element-383d70f elementor-align-center blog-button elementor-widget elementor-widget-button"
    ...
    if ($endIndex !== false) {
        ...
        echo "Successfully replaced visible blogs.\n";
    } else {
